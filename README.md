...
o	Used BotFather to create a bot and obtain the BOT_TOKEN.
2.	Set Up Heroku App
o	Created a new Heroku app via Heroku CLI or dashboard.
o	Added environment variables (config vars):
